...
TEST_F(GTestCast128, Normal_CAST128_128_001) {
  ...
  cast128.initialize(cryptography::CAST128, CAST128_EXAM_128BIT_KEY, sizeof(CAST128_EXAM_128BIT_KEY), false);
...
TEST_F(GTestCast128, Normal_CAST128_80_001) {
  ...
  cast128.initialize(cryptography::CAST128, CAST128_EXAM_80BIT_KEY, sizeof(CAST128_EXAM_80BIT_KEY), false);
...
TEST_F(GTestCast128, Normal_CAST128_40_001) {
  ...
  cast128.initialize(cryptography::CAST128, CAST128_EXAM_40BIT_KEY, sizeof(CAST128_EXAM_40BIT_KEY), false);
