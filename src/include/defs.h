...
#define CRYPTOGRAPHY_LEFT_32BIT_MASK         
  ...
  #elif _WIN32
    #define POPCOUNT64(x)                    (uint64_t)(__popcnt((uint32_t)((x) >> 32                  )) + \
                                                        __popcnt((uint32_t)((x) & 0x0000'0000'FFFF'FFFF)))
#endif
  ...
  #else
    #define POPCOUNT64(x)                    (uint64_t)(__builtin_popcount((uint32_t)((x) >> 32                  )) + \
                                                        __builtin_popcount((uint32_t)((x) & 0x0000'0000'FFFF'FFFF)))
  #endif
#endif
